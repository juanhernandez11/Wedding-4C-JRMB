         ...
         <div class="row justify-content-center">
            <div class="col-lg-7">
               ...
               <div class="error__content">
                  <h3>
                     Oops! Pagina Not Found!
                  </h3>
                  <p>
                     We are really, but the pagina you requested is missing:( Perhaps searching again can help.
                  </p>
                  <a href="index.php?pagina=inicio" class="cmn--btn mt-3">
                     back to home
                  </a>
               </div>
            </div>
